    ...
    createClass(Store, [{
        ...
        value: function toBackendAll() {
            ...
            modelData.forEach(function (model) {
                ...
                forIn(model.relations, function (relModel, key) {
                    ...
                    relations[key] = uniqBy(relations[key], _this7.Model.primaryKey);
                });
            });
        ...
        value: function virtualStore(_ref3) {
            ...
            var events = autorun(function () {
                var models = _this8.filter(filter$$1);
...
var Model = (_class$1 = (_temp$1 = _class2$1 = function () {
    ...
    return Model;
}(), _class2$1.primaryKey = 'id', _class2$1.backendResourceName = '', _class2$1.fileFields = [], _class2$1.pickFields = undefined, _class2$1.omitFields = [], _class2$1.__observableCache = {}, _temp$1), (_descriptor$1 = _applyDecoratedDescriptor$1(_class$1.prototype, '__backendValidationErrors', [observable], {
    enumerable: true,
    initializer: function initializer() {
        return {};
    }
